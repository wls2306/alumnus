 ...
 */
    ...
    public Message getNewsByNewsId(@PathVariable("id")String newsId){
    ...
    public Message getNewsByPartId(@PathVariable("partId")String partId){
    ...
    @JsonView(News.NewsSimpleView.class)
    @UseToken(level = 2)
    public Message getNewsByType(@PathVariable("type")String type){
    ...
    @UseToken(level = 4)
    public Message pubNewsByNewsId(String newsId){
    ...
    @UseToken(level = 2)
    public Message getNewsConditional(String newsId,String newsPartId,String newsType,String newsStatus){
